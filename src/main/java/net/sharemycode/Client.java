...
public class Client {
	...
	public static void main(String[] args) throws IOException {
        ...
        HttpEntity project = createProject("testProject", "testVersion", "description", "~/testProject.zip");
	...
	public HttpResponse postRequest(String postContent, HttpEntity postData) throws ClientProtocolException, IOException {
        ...
        request.addHeader("content-type", "multipart/form-data;boundary=--SMCBoundary_" + generateBoundary());
        HttpResponse response = client.execute(request);
        request.releaseConnection(); // release the connection
        return response;
    }
	...
	public static HttpEntity createProject(String name, String version, String description, String projectPath){
		...
		multipart.addTextBody("pname", name);
		multipart.addTextBody("version", version);
		multipart.addTextBody("description", description);
