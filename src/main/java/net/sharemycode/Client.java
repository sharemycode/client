...
public class Client {
    ...
    public Project createProject(String name, String version, String description, List<String> attachments) {
        ...
        Response response = RESTClient.path("/projects").request().post(Entity.json(data));
    ...
    */
    ...
    public int fetchProject(Project p) {
        ...
        try {
            ...
            System.err.println("Resource: projects/" + p.getId() + "/download\n" + e);
            return 404;
        }
        return status;
    }
